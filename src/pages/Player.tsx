...
const Player = () => {
  ...
  if (
    player &&
    "career_history" in (player as unknown as Record<string, unknown>) &&
    Array.isArray(
      (player as unknown as Record<string, unknown>)["career_history"]
    )
  ) {
    careerHistory =
      (player as unknown as { career_history?: CareerEntry[] })
        .career_history || [];
  } else {
    careerHistory = [
      {
      ...
      },
      {
        season: "2024/2025",
        club: team?.name || "Unknown",
        appearances: Math.max(0, player.appearances - 10),
        assists: Math.max(0, player.assists - 1),
        goals: Math.max(0, player.goals - 3),
      },
    ];
  }
              ...
              <div className="mt-3 grid grid-cols-3 gap-3">
                ...
                <div className="text-center">
                  ...
                  <div className="font-bold">
                    {ch.minutes || player.minutesPlayed}
                  </div>
                </div>
              </div>
            </div>
